...
4. Run the code "feature_extraction_discharge_model.py". This step generates files containing the equivalent features of the discharge model (Severson et al. 2019) and lifetime based on the proper subset partitions ('training_discharge.csv', 'test_in_discharge.csv', and 'test_out_discharge.csv').